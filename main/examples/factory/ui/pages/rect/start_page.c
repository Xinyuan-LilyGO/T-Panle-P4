...
#define START_LINE_MAX_WIDTH           500
...
static void start_page_create(Page *page)
{
    ...
    lv_obj_set_style_bg_color(s_start_line, lv_color_hex(UI_OK), 0);
    ...
    lv_label_set_text(s_start_ui.board_name_label, "T-Panel-P4-Rect");
