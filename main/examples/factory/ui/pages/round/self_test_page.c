...
#define SELF_TEST_CONTENT_W 500
#define SELF_TEST_CONTENT_X ((DISPLAY_PANEL_H_RES - SELF_TEST_CONTENT_W) / 2)
#define SELF_TEST_CONTENT_Y 150
#define SELF_TEST_CONTENT_H 470
#define SELF_TEST_PREVIEW_WIDTH 480
#define SELF_TEST_PREVIEW_HEIGHT 270
...
#define SELF_TEST_ITEM_HEIGHT 52
#define SELF_TEST_ITEM_ICON_WIDTH 36
#define SELF_TEST_ITEM_BUTTON_W 80
#define SELF_TEST_ITEM_BUTTON_H 36
#define SELF_TEST_ITEM_LIST_GAP 6
#define SELF_TEST_ITEM_ICON_FONT (&lv_font_montserrat_20)
#define SELF_TEST_ITEM_TEXT_FONT (&lv_font_SourceHanSansSC_Regular_2_16)
#define SELF_TEST_PAIR_ROW_HEIGHT 34
#define SELF_TEST_PAIR_ROW_FONT (&lv_font_SourceHanSansSC_Regular_2_16)
#define SELF_TEST_RESULT_ROW_INSET 16
#define SELF_TEST_RESULT_ROW_W (SELF_TEST_CONTENT_W - SELF_TEST_RESULT_ROW_INSET * 2)
...
static void self_test_surface_style(lv_obj_t *obj, lv_opa_t background_opa, int32_t radius)
{
...
static void self_test_status_bar_set_hidden(bool hidden)
{
                                         ...
                                         lv_event_cb_t back_cb)
{
    ...
    lv_obj_set_pos(back_button, 125, 78);
    self_test_surface_style(back_button, LV_OPA_50, 24);
    lv_obj_set_style_shadow_width(back_button, 12, 0);
                                  ...
                                  const self_test_item_t *item)
{
    ...
    lv_obj_set_size(row, SELF_TEST_CONTENT_W, SELF_TEST_ITEM_HEIGHT);
    self_test_surface_style(row, LV_OPA_40, LV_RADIUS_CIRCLE);
...
static void self_test_page_create(Page *page)
{
    ...
    lv_obj_set_size(list, SELF_TEST_CONTENT_W, SELF_TEST_CONTENT_H);
    lv_obj_set_pos(list, SELF_TEST_CONTENT_X, SELF_TEST_CONTENT_Y);
    self_test_surface_style(list, LV_OPA_0, 24);
...
static void self_test_page_enter(Page *page)
{
    (void)page;
    self_test_status_bar_set_hidden(true);
}

static void self_test_page_leave(Page *page)
{
    (void)page;
    self_test_status_bar_set_hidden(false);
}
...
static void self_test_display_update(void)
{
    ...
    lv_color_t test_color = lv_color_hex(s_display_test_colors[index]);
    lv_obj_set_style_bg_color(s_run_ui.root, test_color, 0);
    lv_obj_set_style_bg_color(s_run_ui.body, test_color, 0);
    lv_obj_set_style_bg_color(s_run_ui.display_screen, test_color, 0);
...
static void self_test_display_build(void)
{
    ...
    lv_obj_set_style_bg_opa(s_run_ui.root, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(s_run_ui.root, 0, 0);
    lv_obj_set_style_radius(s_run_ui.root, 0, 0);
    lv_obj_set_style_pad_all(s_run_ui.root, 0, 0);

    lv_obj_set_style_bg_opa(s_run_ui.body, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(s_run_ui.body, 0, 0);
    lv_obj_set_style_radius(s_run_ui.body, 0, 0);
    lv_obj_set_style_pad_all(s_run_ui.body, 0, 0);
    lv_obj_set_style_shadow_width(s_run_ui.body, 0, 0);
    lv_obj_set_style_shadow_spread(s_run_ui.body, 0, 0);
    ...
    s_run_ui.display_color_label = self_test_pair_row_create(
        s_run_ui.body, SELF_TEST_CONTENT_X, 126, SELF_TEST_CONTENT_W, "Color", "Red", UI_TEXT);
    s_run_ui.display_step_label = self_test_pair_row_create(
        s_run_ui.body, SELF_TEST_CONTENT_X, 178, SELF_TEST_CONTENT_W, "Step", "1 / 6", UI_TEXT);
    ...
    lv_obj_set_style_bg_opa(s_run_ui.display_next_button, LV_OPA_60, 0);
    ...
    lv_obj_set_style_border_opa(s_run_ui.display_next_button, LV_OPA_40, 0);
    lv_obj_set_style_radius(s_run_ui.display_next_button, 32, 0);
    lv_obj_set_style_shadow_width(s_run_ui.display_next_button, 16, 0);
    lv_obj_set_style_shadow_color(s_run_ui.display_next_button, lv_color_hex(UI_PRIMARY), 0);
    lv_obj_set_style_shadow_opa(s_run_ui.display_next_button, LV_OPA_30, 0);
...
static void self_test_touch_build(void)
{
    ...
    lv_color_t touch_background = lv_color_hex(UI_PANEL);

    lv_obj_set_size(s_run_ui.body, DISPLAY_PANEL_H_RES, DISPLAY_PANEL_V_RES);
    lv_obj_set_pos(s_run_ui.body, 0, 0);
    lv_obj_set_style_bg_color(s_run_ui.root, touch_background, 0);
    lv_obj_set_style_bg_opa(s_run_ui.root, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(s_run_ui.root, 0, 0);
    lv_obj_set_style_radius(s_run_ui.root, 0, 0);
    lv_obj_set_style_pad_all(s_run_ui.root, 0, 0);

    lv_obj_set_style_bg_color(s_run_ui.body, touch_background, 0);
    lv_obj_set_style_bg_opa(s_run_ui.body, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(s_run_ui.body, 0, 0);
    lv_obj_set_style_radius(s_run_ui.body, 0, 0);
    lv_obj_set_style_pad_all(s_run_ui.body, 0, 0);
    ...
    lv_obj_set_style_bg_color(pad, touch_background, 0);
    ...
    s_run_ui.finger_count_label = self_test_pair_row_create(
        s_run_ui.body, SELF_TEST_CONTENT_X, 126, SELF_TEST_CONTENT_W, "Fingers", "0", UI_TEXT);
    s_run_ui.touch_position_label = self_test_pair_row_create(
        s_run_ui.body, SELF_TEST_CONTENT_X, 178, SELF_TEST_CONTENT_W, "Position", "--", UI_TEXT);
...
static void self_test_result_row_create(int32_t y, const char *name, bool passed)
{
    ...
    lv_obj_set_size(row, SELF_TEST_RESULT_ROW_W, 50);
    lv_obj_set_pos(row, SELF_TEST_RESULT_ROW_INSET, y);
...
static void self_test_storage_build(void)
{
    ...
    const int32_t info_y = 218;
    const int32_t info_step = 34;
    const int32_t written_y = info_y + info_step * 5;
    const int32_t readback_y = info_y + info_step * 6;
    self_test_pair_row_create(s_run_ui.body, 0, info_y, SELF_TEST_CONTENT_W,
                              "Type", info.type[0] ? info.type : "--", UI_TEXT);
    self_test_pair_row_create(s_run_ui.body, 0, info_y + info_step, SELF_TEST_CONTENT_W,
                              "Bus", info.bus[0] ? info.bus : "--", UI_TEXT);
    self_test_pair_row_create(s_run_ui.body, 0, info_y + info_step * 2, SELF_TEST_CONTENT_W,
                              "Mounted", info.app_mounted ? "Yes" : "No", UI_TEXT);
    self_test_pair_row_create(s_run_ui.body, 0, info_y + info_step * 3, SELF_TEST_CONTENT_W,
                              "Total", total_text, UI_TEXT);
    self_test_pair_row_create(s_run_ui.body, 0, info_y + info_step * 4, SELF_TEST_CONTENT_W,
                              "Free", free_text, UI_TEXT);
    self_test_pair_row_create(s_run_ui.body, 0, written_y, SELF_TEST_CONTENT_W,
                              "Written", SELF_TEST_STORAGE_TEXT, UI_TEXT);
    self_test_pair_row_create(s_run_ui.body, 0, readback_y, SELF_TEST_CONTENT_W,
                              "Read back",
...
static void self_test_audio_build(void)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        lv_obj_set_style_shadow_width(bar, 10, LV_PART_MAIN);
        lv_obj_set_style_shadow_color(bar, lv_color_hex(UI_PRIMARY), LV_PART_MAIN);
        lv_obj_set_style_shadow_opa(bar, LV_OPA_20, LV_PART_MAIN);
        s_run_ui.audio_bars[i] = bar;

        lv_obj_t *value = lv_label_create(s_run_ui.body);
        lv_label_set_text(value, "-- dB");
        lv_obj_set_size(value, 125, 40);
        lv_obj_set_pos(value, 375, y + 42);
    ...
    lv_obj_set_size(speaker_row, SELF_TEST_CONTENT_W, 60);
    ...
    lv_obj_set_size(play_button, 220, 52);
    ...
    lv_obj_set_style_radius(play_button, 26, 0);
    lv_obj_set_style_shadow_width(play_button, 14, 0);
    lv_obj_set_style_shadow_color(play_button, lv_color_hex(UI_PRIMARY), 0);
    lv_obj_set_style_shadow_opa(play_button, LV_OPA_30, 0);
...
static void self_test_camera_build(void)
{
    ...
    lv_obj_set_style_border_color(preview, lv_color_hex(UI_PRIMARY), 0);
    lv_obj_set_style_border_opa(preview, LV_OPA_50, 0);
    lv_obj_set_style_radius(preview, 18, 0);
    lv_obj_set_style_shadow_width(preview, 18, 0);
    lv_obj_set_style_shadow_color(preview, lv_color_hex(UI_PRIMARY), 0);
    lv_obj_set_style_shadow_opa(preview, LV_OPA_30, 0);
...
static void self_test_power_build(void)
{
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        s_run_ui.power_values[i] = self_test_pair_row_create(
            s_run_ui.body, 0, y, SELF_TEST_CONTENT_W,
            names[i], "--", UI_TEXT);
    }
...
static void self_test_lora_build(void)
{
    ...
    self_test_status_create(communication_ok ? "LoRa communication passed" : initialized ? "LoRa communication failed"
                                                                                         : "LoRa initialization failed",
                            communication_ok ? UI_OK : UI_ERROR);
    self_test_pair_row_create(s_run_ui.body, 0, 60, SELF_TEST_CONTENT_W,
                              "Initialization",
                              initialized ? "Passed" : "Failed",
                              initialized ? UI_OK : UI_ERROR);
    self_test_pair_row_create(s_run_ui.body, 0, 104, SELF_TEST_CONTENT_W,
                              "SPI communication",
                              communication_ok ? "Passed" : "Failed",
                              communication_ok ? UI_OK : UI_ERROR);
    self_test_pair_row_create(s_run_ui.body, 0, 148, SELF_TEST_CONTENT_W,
                              "Chip",
                              initialized ? lora_page_chip_name(lora_app_get_chip()) : "--",
                              initialized ? UI_TEXT : UI_MUTED);
    self_test_pair_row_create(s_run_ui.body, 0, 192, SELF_TEST_CONTENT_W,
                              "Mode",
...
static void self_test_c5_refresh(void)
{
    ...
    const char *init_text = init_failed ? "Failed" : ready ? "Passed"
                                                           : "Pending";
    uint32_t init_color = init_failed ? UI_ERROR : ready ? UI_OK
                                                         : UI_WARN;
    ...
    if (!probe_done)
    {
        ...
        lv_label_set_text(s_run_ui.status,
                          init_failed ? "ESP32-C5 initialization failed" : ready ? "Waiting for communication test"
                                                                                 : "ESP32-C5 initializing");
        lv_obj_set_style_text_color(s_run_ui.status,
    ...
    lv_label_set_text(s_run_ui.status,
                      probe_ok ? "ESP32-C5 communication passed" : "ESP32-C5 communication failed");
    lv_obj_set_style_text_color(s_run_ui.status,
...
static void self_test_c5_build(void)
{
    ...
    s_run_ui.c5_values[0] = self_test_pair_row_create(
        s_run_ui.body, 0, 60, SELF_TEST_CONTENT_W, "Initialization", "Pending", UI_WARN);
    s_run_ui.c5_values[1] = self_test_pair_row_create(
        s_run_ui.body, 0, 104, SELF_TEST_CONTENT_W, "Enabled", "--", UI_MUTED);
    s_run_ui.c5_values[2] = self_test_pair_row_create(
        s_run_ui.body, 0, 148, SELF_TEST_CONTENT_W, "RPC communication", "Pending", UI_WARN);
    s_run_ui.c5_values[3] = self_test_pair_row_create(
        s_run_ui.body, 0, 192, SELF_TEST_CONTENT_W, "Target", "--", UI_MUTED);
    s_run_ui.c5_values[4] = self_test_pair_row_create(
        s_run_ui.body, 0, 236, SELF_TEST_CONTENT_W, "Chip ID", "--", UI_MUTED);
...
static void self_test_run_page_create(Page *page)
{
    ...
    lv_obj_set_size(s_run_ui.body, SELF_TEST_CONTENT_W, SELF_TEST_CONTENT_H);
    lv_obj_remove_flag(s_run_ui.body, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_pos(s_run_ui.body, SELF_TEST_CONTENT_X, SELF_TEST_CONTENT_Y);
    self_test_surface_style(s_run_ui.body, LV_OPA_20, 24);
    lv_obj_set_style_pad_all(s_run_ui.body, 0, 0);
...
static void self_test_run_page_enter(Page *page)
{
    ...
    lv_obj_set_style_bg_color(s_run_ui.root, lv_color_hex(UI_BG), 0);
    lv_obj_set_style_bg_opa(s_run_ui.root, LV_OPA_COVER, 0);
    lv_obj_set_size(s_run_ui.body, SELF_TEST_CONTENT_W, SELF_TEST_CONTENT_H);
    lv_obj_remove_flag(s_run_ui.body, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_pos(s_run_ui.body, SELF_TEST_CONTENT_X, SELF_TEST_CONTENT_Y);
...
void self_test_page_register(void)
{
    Page list_page = {
        ...
        .on_enter = self_test_page_enter,
        .on_leave = self_test_page_leave,
